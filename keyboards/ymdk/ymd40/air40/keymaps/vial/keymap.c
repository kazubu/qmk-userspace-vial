...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = LAYOUT_ortho_4x12(
        ...
        KC_LCTL, KC_LGUI, KC_LALT, LT(1,KC_LNG2),KC_SPC,XXXXXXX,XXXXXXX,KC_ENT, LT(2,KC_LNG1),KC_RALT,KC_APP,KC_RCTL
    ),
    ...
    [_ADJUST] = LAYOUT_ortho_4x12(
        ...
        _______, RGB_HUI, KC_BRIU, KC_VOLU, KC_LNG2, RGB_VAI, RGB_SAI, KC_LNG1, RGB_TOG, DT_UP  , DT_PRNT, KC_F12,
        _______, RGB_HUD, KC_BRID, KC_VOLD, KC_MUTE, RGB_VAD, RGB_SAD, XXXXXXX, RGB_MOD, DT_DOWN, KC_SCRL, KC_PSCR,
